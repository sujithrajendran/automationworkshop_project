...
<title>ViewInprogressticket Page</title>
...
<form action="ViewInprogressticket.jsp" method="post">
<% String id="";
   String mobilenumber="";
   String firstname="";
...
if(con!=null)
{
	try
	{
	    ...
	    ResultSet rs=st.executeQuery( "select ticketnumber,ticketstatus,customername,vehicletype,companyname,vehiclemodel,registernumber,area,pincode,shopid,dealerid,mechanicid,fault,amount,deliverystatus,sparesreplaced,customerid from ticketquery where dealerid='"+id+"' and ticketstatus='In-Progress'");
	    while(rs.next()) 
	    { 
	...
	<nav id="nav">
			<div class="innertube">
				...
				<li><a href="WelcomeDealer.jsp">Home</a></li>
					<li><a href="ViewInprogressticket.jsp">View Closed Ticket</a></li>				
				</ul>
			</div>
		</nav>
		</form>
