...
<form action="DealerProfile.jsp" method="post">
...
if(conn!=null)
{
	try
	{
	    ...
	    ResultSet rs=st.executeQuery("select firstname,lastname,mobilenumber,emailid,address,gender,id from details where id='"+id+"' ");
	    while(rs.next()) 
	    { 
...
<div class="container">
     ...
     <span style="font-size:120%; color:#ffffff;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Address -</span>
      <span style="font-size:120%; color:#99ffff;"> <%=address%>
       ...
       <br>
       <center>
     <a class="msg-btn" target="_blank" onclick="window.location.href='UpdateDealerProfile.jsp'">Update</a>
    </div>
  </div> 
  </div>
    </center>
