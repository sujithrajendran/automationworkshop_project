...
<title>Clossed Ticket Page</title>
...
<form action="Viewclosedticket.jsp" method="post">
<% String id="";
   String mobilenumber="";
   String firstname="";
...
if(con!=null)
{
	try
	{
	    ...
	    ResultSet rs=st.executeQuery( "select ticketnumber,ticketstatus,customername,vehicletype,companyname,vehiclemodel,registernumber,area,pincode,shopid,dealerid,mechanicid,fault,amount,deliverystatus,sparesreplaced,customerid from ticketquery where dealerid='"+id+"' and ticketstatus='Closed'");
	    while(rs.next()) 
	    { 
