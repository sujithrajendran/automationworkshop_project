...
<form action="WelcomeDealer.jsp" method="post">
<% String id="";
   String mobilenumber="";
   String firstname="";
...
if(con!=null)
{
	try
	{
	    ...
	    ResultSet rs=st.executeQuery( "select ticketnumber,ticketstatus,vehicletype,companyname,vehiclemodel,registernumber,deliverystatus,shopid,mechanicid,fault,customername from ticketquery where dealerid='"+id+"' and ticketstatus='In-Progress'");
	    while(rs.next()) 
	    { 
...
%>		
	...
	<nav id="nav">
			<div class="innertube">
				<h2>Dealer</h2>
				<ul>
			     	<li><a href="DealerProfile.jsp">Profile</a></li>
					...
					<li><a href="ViewInprogressticket.jsp">View In-Progress Ticket</a></li>
					<li><a href="Viewclosedticket.jsp">View Closed Ticket</a></li>
